...
const DesktopSidebar: React.FC<DesktopSidebarProps> = ({
  ...
  return (
    <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-20 xl:px-6 lg:overflow-y-auto lg:bg-white dark:lg:bg-neutral-900 lg:border-r-[1px] dark:lg:border-neutral-700 lg:pb-4 lg:flex lg:flex-col justify-between">
